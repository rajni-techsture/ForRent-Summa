    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            If Session("FacebookAccessToken") <> Nothing AndAlso Session("FacebookAccessToken") <> "" Then
                ...
                hdnCompanyId.Value = 0 'GetSetCookies.GetCookie("CompanyId")
                hdnIndustryId.Value = 1 'GetSetCookies.GetCookie("IndustryId")
    ...
    Public Function BindCustomTabAll()
        Try
            If Session("FacebookAccessToken") <> Nothing AndAlso Session("FacebookAccessToken") <> "" Then
                ...
                'objBAL.CompanyId = Convert.ToInt32(GetSetCookies.GetCookie("CompanyId")) 'Session("CompanyId")
                'objBAL.IndustryId = Convert.ToInt32(GetSetCookies.GetCookie("IndustryId")) 'Session("IndustryId")
                ds = objBAL.GetCustomTabMasterByCompOrIndustry
                If ds.Tables(0).Rows.Count > 0 Then
    ...
    Public Function BindCustomTabByPageIndex()
        Try
            If Session("FacebookAccessToken") <> Nothing AndAlso Session("FacebookAccessToken") <> "" Then
                ...
                objBAL.IndustryId = 1 ' GetSetCookies.GetCookie("IndustryId") 'Session("IndustryId")
                'objBAL.CompanyId = Convert.ToInt32(GetSetCookies.GetCookie("CompanyId")) 'Session("CompanyId")
                'objBAL.IndustryId = Convert.ToInt32(GetSetCookies.GetCookie("IndustryId"))
                ds = objBAL.GetCustomTabMasterByCompOrIndustry
                If ds.Tables(0).Rows.Count > 0 Then
