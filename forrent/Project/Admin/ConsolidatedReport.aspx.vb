...
#Region "Create CSV"
    Sub Create_Csv()
        Try
            ...
            Dim ds As New DataSet
            ds = obj.DownLoadConsolidatedReport()

            Dim strPath As String = "Consolidated Report-" & CStr(Day(Now)) & CStr(Month(Now)) & CStr(Year(Now)) & CStr(Hour(Now)) & CStr(Minute(Now)) & CStr(Second(Now)) & ".csv"
            Response.Expires = 0
            Response.Clear()
            ...
            For i = 0 To ds.Tables(0).Rows.Count - 1
                With ds.Tables(0).Rows(i)
                    Response.Write("""" & .Item("t_Id").ToString() & """,")
                    Response.Write("""" & .Item("t_TmpId").ToString() & """,")
                    Response.Write("""" & .Item("t_Event").ToString() & """,")
                    Response.Write("""" & .Item("t_User").ToString() & """,")
                    Response.Write("""" & .Item("t_Date").ToString() & """,")
