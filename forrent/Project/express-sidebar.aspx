<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="express-sidebar.aspx.vb" Inherits="tsma.express_sidebar" %>
...
<script type="text/javascript">
    function ShowHideDiv(Id) {
        ...
        var sdId = document.getElementById("hdnExpressId").value;
        window.location.href="sidebar_selection.aspx?sdId=" + sdId + "&userId=" + userId + "&FbuserId=" + FbuserId + "&CId=" + CompanyId + "&IId=" + IndustryId;
		//document.getElementById("Iframe1").src = "sidebar_selection.aspx?sdId=" + sdId + "&userId=" + userId + "&FbuserId=" + FbuserId + "&CId=" + CompanyId + "&IId=" + IndustryId;
