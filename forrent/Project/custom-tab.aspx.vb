    ...
    Private Sub btnCreate_ServerClick(sender As Object, e As System.EventArgs) Handles btnCreate.ServerClick
        Try
            ...
            If result.ToLower = "true" Then
                ...
                objCustomTab.Content = txtContent.Value.Trim
                ...
                lnkEditTab.HRef = "https://www.facebook.com/pages/" & ViewState("PageName").ToString.Replace(" ", "-") & "/" & ViewState("PageID") & "/?sk=app_" & AppID
            Else
