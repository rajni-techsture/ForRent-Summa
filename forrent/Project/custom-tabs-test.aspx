<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="custom-tabs-test.aspx.vb" Inherits="tsma.custom_tabs_test" %>
...
<script type="text/javascript">
    function ShowHideDiv(Id) {
       ...
       var CompanyId = document.getElementById("hdnCompanyId").value;  //var CompanyId = 0 
       var IndustryId = document.getElementById("hdnIndustryId").value; //var IndustryId = 1 
        document.getElementById("Iframe1").src = "custom-tab-selection-edit-test.aspx?ctId=" + Id + "&userId=" + userId + "&FbuserId=" + FbuserId + "&CId=" + CompanyId + "&IId=" + IndustryId;
    }
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <tr>
                                 ...
                                 View All</a>&nbsp;&nbsp;<a href="javascript:;" onclick="ShowHidePaging('bypage');" class="bluetablink">View By Page</a >
                            ...
                            <tr><td>
                             ...
                             <asp:UpdatePanel ID="pnlMain" runat="server">
                                      <ContentTemplate>
                                        <table cellpadding="0" id="trPaging" runat="server"  cellspacing="0" border="0" width="100%">
                                          <tr>
                                                ...
                                                <ItemTemplate>
                                                  <table align="center">
                                                    <tr>
                                                       ...
                                                       <a id="lnkCustomTab" href="javascript:;" onclick='ShowCustomTab(<%#Container.DataItem("ctm_Id") %>)'><img  alt="" src='Content/images/customtab/<%#Container.DataItem("ctm_Image") %>' border="0"/></a>
                                    ...
                                    <ItemTemplate>
                                      <%--<a id="lnkSidebar" href="javascript:;" onclick='ShowHideDiv(<%#Container.DataItem("ctm_Id") %>)'><img  alt="" width="1000px" src='Content/images/<%#Container.DataItem("ctm_Image") %>' border="0"/></a>--%>
                                        <%--<a id="lnkSidebar" onclick="ShowHideDiv()" href="sidebar_selection.aspx?sdId=<%#Container.DataItem("sdm_Id") %>&userId=<%#Container.DataItem("sdm_UserId")%>&FbuserId=&CId=<%#Container.DataItem("sdm_CompanyId")%>&IId=<%#Container.DataItem("sdm_IndustryId")%>"><img  alt="" src='Content/images/<%#Container.DataItem("sdm_Image") %>' border="0"/></a>--%>
                                         ...
                                         <div style="font-family: Tahoma, Geneva, sans-serifthaoma; font-size: 14px; color: #181818; font-weight:bold; text-align:center; "><%#Container.DataItem("ctm_Name")%></div><br />
											<img  alt="" src='Content/images/customtab/<%#Container.DataItem("ctm_Image") %>' border="0"/>
										 </div>
                                                  ...
                                                  <table align="center">
                                                    <tr>
                                                      <td style="padding-bottom:20px;" valign="top">
                                                       <div style="font-family: Tahoma, Geneva, sans-serifthaoma; font-size: 14px; color: #181818; font-weight:bold; text-align:center; "><%#Container.DataItem("ctm_Name")%></div><br />
                                                      <a id="lnkCustomTab1" href="javascript:;" onclick='ShowCustomTab(<%#Container.DataItem("ctm_Id") %>)'><img  alt="" src='Content/images/customtab/<%#Container.DataItem("ctm_Image") %>' border="0"/></a><hr />
...
<script type="text/javascript">
    ...
    function ShowCustomTab(Id) {
        ...
        document.getElementById("Iframe1").src = "custom-tab-selection-test.aspx?ctId=" + Id + "&userId=" + userId + "&FbuserId=" + FbuserId + "&CId=" + CompanyId + "&IId=" + IndustryId;
    }
</script>
