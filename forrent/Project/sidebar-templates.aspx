<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="sidebar-templates.aspx.vb" Inherits="tsma.sidebar_templates" %>
...
<form id="frm" runat="server">
  ...
  <div id="innerpagepagemain">
	...
	line-height:18px; text-align:center">Click on image to choose your desired sidebar </div><br />
                            <asp:Label ID="lblMessage" runat="server" ForeColor="Red" Font-Bold=true Font-Size="Larger"></asp:Label>
                                ...
                                <tr>
                                  ...
                                  All</a>&nbsp;&nbsp;<a href="javascript:;" onclick="ShowHidePaging('bypage');" class="bluetablink">View By Page</a ></td>
                                </tr>
                                <tr>
                                          ...
                                          <tr>
                                            <td align="center" style="border:1px solid #ced5e5; padding-top:29px; padding-bottom:29px;"><asp:DataList ID="rptPaging" runat="server" RepeatColumns="2" RepeatDirection="Vertical">
                                                <ItemTemplate>
                                                  <table align="center">
                                                    <tr>
                                                      <td><a id="lnkSidebar" href="javascript:;" onclick='ShowSidebar(<%#Container.DataItem("sdm_Id") %>)'><img  alt="" src='Content/images/sidebar/<%#Container.DataItem("sdm_Image") %>' border="0"/></a>
                                                ...
                                                <ItemTemplate>
                                                  <table align="center">
                                                    <tr>
                                                      ...
                                                      <a id="lnkSidebar1" href="javascript:;" onclick='ShowSidebar(<%#Container.DataItem("sdm_Id") %>)'><img  alt="" src='Content/images/sidebar/<%#Container.DataItem("sdm_Image") %>' border="0"/></a>
