...
<script type="text/javascript">
	...
	function OpenSaveCoverPhotoName()
	{
		  var maskHeight = $(document).height();
	   var maskWidth = $(window).width();
	   $('#DivCoverPhotoName').css({'width':maskWidth,'height':maskHeight});
...
<div id="DivShareCoverPhoto" style="width:100%; height:100%; text-align:center; background-image:url(Content/facebookalert/images/popup_bg.png); position:absolute; z-index:999999999; text-align:center;  display:none;">
			  <div id="popup_container1" style="width:450px; height:80px;"  >
			    <div id="popup_content" style="padding-top:10px; padding-left:20px; text-align:left">
                  Cover Photo Shared Successfully<br/><br/>
      ...
      <div id="DivPublishSaveCoverPhoto" style="width:100%; height:100%; text-align:center; background-image:url(Content/facebookalert/images/popup_bg.png); position:absolute; z-index:999999999; text-align:center;  display:none;">
			  <div id="popup_container1" style="width:450px; height:80px;"  >
			    <div id="popup_content" style="padding-top:10px; padding-left:20px; text-align:left">
                  Cover Photo published to your Page successfully<br/><br/>
			  ...
			  <div id="popup_container1" style="width:450px; height:80px;" >
			    <div id="popup_content" style="padding-top:10px; padding-left:20px; text-align:left;">
                  Cover Photo Name:  <input type="text" runat="server" id="txtCoverPhotoName" width="100" height="20" /><br/><br/>
                   <a href="javascript:;" id="lnkSaveName" runat="server" style="display:" class="bluetablink" onclick="return ValidateSaveName();">Save</a>&nbsp;&nbsp;<a href="javascript:;" class="bluetablink" onclick='$("#DivCoverPhotoName").hide("slow");'>Cancel</a>
				</div>
			 </div>
			 </div>
        ...
        <td style="border:1px solid #bdc7d8; background-color:#FFF; padding-left:20px;">                <div id="editor-nav">
          <div class="editor-nav-panel rc-m">
            <div class="editor-nav-panel-content">
              ...
              <div id="helptext1" style="background-image:url(content/images/facebook_frame_coaching2_video_bg.png); background-position:top; background-repeat:no-repeat; width:680px; height:474px; text-align:left;position:absolute;top:-500px;left:-100px;display:none;z-index:90000">
              ...
              <a id="ch_temp"  href="create-cover-photo" target="_parent" class="nav-action-button rc-m " title="Change Template for this Page." onclick="return SubMenu(this);"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Change Template</a><a id="lnkResize"  href="javascript:;" target="_parent" class="nav-action-button rc-m " title="Crop Image" onclick="PopupCenter('crop2.aspx', 'Resize','800','700');"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Crop Image</a>
              ...
              <a href="javascript:;"   class="nav-action-button rc-m " title="Share with business &nbsp;page admins" id="lnkSaveAndShare" onclick="return OpenShareCoverPhotoName();" style="display:;"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px; line-height:20px;"  />Share With Business Page &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Admins</a>
              <a href="javascript:;"  class="nav-action-button rc-m " title="Save CoverPhoto" id="lnkSave" onclick="return OpenSaveCoverPhotoName();" ><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Save</a>
              ...
              <a href="#"  id="lnkDownload" runat="server" style="display:none" ></a>
               <div style="padding-left:200px; padding-top:200px;"><img id="imgLoading" src="content/images/bigspinner.gif" style="display:none" /> </div>
			   <!--
...
<div style="display:none; opacity: 1; left: 758px; width:420px; top: 244px; height: 258px;clear:both; padding-left:30px;" id="rm-appearance-panel" class="">
...
//        $(".urlandtext:eq(" + index + ")").attr('onclick', 'setLocation(\'' + url + '\');');
    ...
    function videosmall(url, id) {
        ...
        $.ajax({
            ...
            success: function (data) {
                $('#' + id).html(data);
                $('#spinner').fadeOut('slow', function () { $("div[rel=" + id + "] img:first").attr("src", "https://mysocialmediaagency.com/tsms_beta/playimgsmall.php?img=http://img.youtube.com/vi/" + vid + "/2.jpg"); });
            }
        });
