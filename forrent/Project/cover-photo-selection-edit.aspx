<%@ Page Language="vb" AutoEventWireup="false" Debug="true" validateRequest="false" CodeBehind="cover-photo-selection-edit.aspx.vb" Inherits="tsma.cover_photo_selection_edit" %>
...
<script type="text/javascript">
	...
	function OpenShareCoverPhotoName()
	{
	   var maskHeight = $(document).height();
	   var maskWidth = $(window).width();
	   $('#DivShareCoverPhotoName').css({'width':maskWidth,'height':maskHeight});
	  $("#DivShareCoverPhotoName").show("slow");
	}
	function ValidateShareName()
				{
					var Title = "Please Fill in Following Information\n";
					var fields = "";
					if ($.trim($('#txtShareCoverPhotoName').val()) == '') {
						fields = fields + "\n-- Cover Photo Name --";
					}
					if (fields.length > 0) {
						alert(Title + fields);
...
<script type="text/javascript" src="Content/facebookalert/facebookalert_files/jquery_facebook.alert.js"></script>
	<script type="text/javascript">
	    ...
	    function DownloadAlert() {
	        jPrompt('Cover Photo will be downloaded to download folder on your computer', ' test ', 'Download Cover Photo',
				    function (r) {
				        if (r == true) {
 ...
 <div id="DivSaveCoverPhoto" style="width:100%; height:100%; text-align:center; background-image:url(Content/facebookalert/images/popup_bg.png); position:absolute; z-index:999999999; text-align:center;  display:none;">
			  <div id="popup_container1" style="width:450px; height:80px;" >
			    <div id="popup_content" style="padding-top:10px; padding-left:20px; text-align:left">
                   ...
                   <input type="button" class="inputbutton" onclick="HideSaveAlert();" value="Close" style=" cursor:pointer;"  id="popup_close" />
				</div>
			 </div>
			 </div>
			  ...
			  <div id="popup_container1" style="width:450px; height:80px;" >
			    <div id="popup_content" style="padding-top:10px; padding-left:20px; text-align:left;">
                  Cover Photo Name:  <input type="text" runat="server" id="txtCoverPhotoName" width="100" height="20" /><br/><br/>
                   <input type="button" class="inputbutton" onclick="HideCoverPhotoNameAlert();" style="cursor:pointer" value="Save" id="popup_save" />&nbsp;&nbsp;<a href="javascript:;" class="bluetablink" onclick='$("#DivCoverPhotoName").hide("slow");'>Cancel</a>
				</div>
			 </div>
			 </div>
             <div id="DivShareCoverPhotoName" style="width:100%; height:100%; text-align:center; background-image:url(Content/facebookalert/images/popup_bg.png); position:absolute; z-index:999999999; text-align:center;  display:none;">
			  <div id="popup_container1" style="width:450px; height:80px;" >
			    <div id="popup_content" style="padding-top:10px; padding-left:20px; text-align:left">
                  Cover Photo Name:  <input type="text" runat="server" id="txtShareCoverPhotoName" width="100" height="20" /><br/><br/>
                   <a href="javascript:;" id="lnkShareName" runat="server" style="display:" class="bluetablink" onclick="return ValidateShareName();">Save</a>&nbsp;&nbsp;<a href="javascript:;" class="bluetablink" onclick='$("#DivShareCoverPhotoName").hide("slow");'>Cancel</a>
				</div>
			 </div>
			 </div>
      ...
      <div class="watch_video_tut_box_cover" style="padding-left:10px;">
       ...
       <div style="font-family: Tahoma, Geneva, sans-serifthaoma; font-size: 14px; color: #181818; font-weight:bold; text-align:center; width:850px; padding-bottom:10px;"><asp:Label ID="txtname" runat="server"></asp:Label></div> 
        ...
        html,body{padding:0px;margin:0px;background-color: transparent;}.SafariBgFix{background-repeat:no-repeat;}
            ...
            <br />
            <div id="divCoverPhotoHtml" runat="server"></div><br />
            <font style=" font-size:14px; font-weight:bold"><div style="width:800px;"><span  id="lnkFanPageName" runat="server"></span></div></font>
           </div>
          </div>
    </ContentTemplate>
  </asp:UpdatePanel>
...
<div class="watch_video_tut_box" style="padding-top:5px; padding-left:150px;">
        ...
        <td style="border:1px solid #bdc7d8; background-color:#FFF; padding-left:20px;">                <div id="editor-nav">
          <div class="editor-nav-panel rc-m">
            <div class="editor-nav-panel-content">
              <a  href="#" class="nav-action-button rc-m rm-css-control-close" title="Watch Video Tutorial" onclick="$('#helptext1').fadeIn();"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Watch Video Tutorial</a> 
              <div id="helptext1" style="background-image:url(content/images/facebook_frame_coaching2_video_bg.png); background-position:top; background-repeat:no-repeat; width:660px; height:474px; text-align:left;position:absolute;top:-500px;left:-100px;display:none;z-index:90000">
              ...
              <a id="ch_temp"  href="create-cover-photo" target="_parent" class="nav-action-button rc-m " title="Change Template for this Page." onclick="return SubMenu(this);"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Change Template</a><a id="lnkResize"  href="javascript:;" target="_parent" class="nav-action-button rc-m "  title="Crop Image" onclick="PopupCenter('crop2.aspx', 'Resize','900','800');"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Crop Image</a>
              ...
              <a href="javascript:;"  class="nav-action-button rc-m " title="Share with business &nbsp;page admins" id="lnkSaveAndShare" runat="server" onclick="return OpenShareCoverPhotoName();" style="display:;"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px; line-height:20px;"  />Share With Business Page &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Admins</a>
              ...
              <div style="padding-left:200px; padding-top:200px;"><img id="imgLoading" src="Https://www.mysocialmediaagency.com/tsms_beta/images/bigspinner.gif" style="display:none" /> </div>
...
<table width="599" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="left" valign="top" style="padding:27px; padding-top:15PX; border-bottom:1px solid #dde2eb; border-right:1px solid #dde2eb; background-color:#f3f4f8">							
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="center" style="vertical-align:middle; line-height:18px; padding-top:10px; padding-bottom:15px;">
        <span id="spnAssigned" runat="server"></span>
        </td>
        </tr>
    </table>
    </td>
...
<div style="display:none; opacity: 1; left: 758px; top: 244px; width:420px; height: 258px;clear:both; padding-left:30px;" id="rm-appearance-panel" class="">
<div style="background-image:url(content/sidebar-images/widget_box_bg.png); width:392px;height:187px;  padding:0px; padding-top:9px;display:a"  id="rm-appearance-type" class="rm-css-subpanel" >
  <div style="position:absolute; left:16px; top:17px;"><img border="0" src="content/sidebar-images/widget_top_arrow.png" width="32" height="26" /></div>
...
<script type="text/javascript">
    ...
    */
    ...
    $("div[rel^=video]").click(function (e) {
        ...
        form = '<div style="font-size:16px"><b>Enter YouTube URL : </b><br><br> <input type="text" id="videourl" value="https://www.youtube.com/watch?v=bfKBk28ObRs&feature=topvideos"  size="38" style="font-size:16px"/>  <input type="button" value="Upload" onClick="' + func + '(document.getElementById(\'videourl\').value,\'' + id + '\');fboxhide();" /> </div>';
...
//        $(".url:eq(" + index + ")").attr('onclick', 'setLocation(\'' + url + '\');');
    ...
    function videobig(url, id) {
        ...
        $.ajax({
            ...
            success: function (data) {
                $('#' + id).html(data);
                $('#spinner').fadeOut('slow', function () { $('#' + id).css('background-image', "url(https://mysocialmediaagency.com/tsms_beta/playimgbig.php?img=https://mysocialmediaagency.com/tsms_beta/thumb.php?x=370%26y=229%26src=http://img.youtube.com/vi/" + vid + "/0.jpg)"); });
            }
        });
    ...
    function videosmall(url, id) {
        ...
        $.ajax({
            ...
            success: function (data) {
                $('#' + id).html(data);
                $('#spinner').fadeOut('slow', function () { $("div[rel=" + id + "] img:first").attr("src", "https://mysocialmediaagency.com/tsms_beta/playimgsmall.php?img=https://img.youtube.com/vi/" + vid + "/2.jpg"); });
            }
        });
