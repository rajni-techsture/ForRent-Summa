<%@ Page Language="vb" AutoEventWireup="false" Debug="true" validateRequest="false" CodeBehind="sidebar_selection.aspx.vb" Inherits="tsma.sidebar_selection" %>
			  ...
			  <div id="popup_container1" style="width:450px; height:80px;" >
			    <div id="popup_content" style="padding-top:10px; padding-left:20px; text-align:left">
                  Sidebar Name:  <input type="text" runat="server" id="txtSidebarName" width="100" height="20" /><br/><br/>
                   <input type="button" class="inputbutton" onclick="HideSidebarNameAlert();" value="Save" id="popup_save" />
				</div>
			 </div>
			 </div>
...
<table width="387" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td align="left" valign="top" style="padding:27px; padding-top:15PX; border-bottom:1px solid #dde2eb; border-right:1px solid #dde2eb; background-color:#EDEFF4"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td height="50" align="center" valign="middle" style="vertical-align:middle; font-weight:bold; line-height:18px;; padding-top:20px; padding-bottom:5px; border-top:1px solid #FFF; display:none"><br />For ideal branding, pair up with the corresponding <br>
          # for your Sidebar</td>
      </tr>
      <tr>
        ...
        <td style="border:1px solid #bdc7d8; background-color:#FFF; padding-left:20px; padding-right:20px;">                <div id="editor-nav">
                  <div class="editor-nav-panel rc-m">
                    <div class="editor-nav-panel-content">
                      ...
                      <a id="ch_temp"  href="javascript:;" target="_parent" class="nav-action-button rc-m " title="Change Template for this Page." onclick="chkTemplatePage3('Warning! Please Save your work befor leave this page othrewise your changes will be descarded');"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Change Template</a><a id="lnkResize"  href="javascript:;" target="_parent" class="nav-action-button rc-m " style="width:190px;" title="Crop Image" onclick="PopupCenter('crop2.aspx', 'Resize','800','700');"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;" border="0"/>Crop Image</a>
