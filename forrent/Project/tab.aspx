<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="tab.aspx.vb" Inherits="tsma.tab" %>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
<title></title>
<link href="https://www.tsmaapplication.com/Content/css/sidebar_style_2.css" rel="stylesheet" type="text/css" />
<style>
body {
	width:520px;
	overflow:hidden;
...
<link type="text/css" href="https://www.tsmaapplication.com/Content/css/sidebar_style.css" rel="stylesheet" media="all" />
<link href="https://www.tsmaapplication.com/Content/facebox/facebox.css" media="screen" rel="stylesheet" type="text/css" />
<link href="https://www.tsmaapplication.com/Content/facebox/faceplant.css" media="screen" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="https://www.tsmaapplication.com/content/js/jquery-1.6.2.js"></script>
...
if (fields != "") {
    ...
    $.ajax({ url: 'https://www.tsmaapplication.com/ajax/ajax-custom-tab-info.aspx?nm=' + $("#name").val() + '&em=' + $("#email").val() + '&ph=' + $("#phno").val() + '&msg=' + $("#msg").val() + '&fbuid=' + $("#hdnFBUserId").val() + '&tsmauid=' + $("#hdnTSMAUserId").val() + '&fbpid=' + $("#hdnFBPageId").val() + '&fbpagename=' + $("#hdnFBPageName").val() + '&fbpageurl=' + $("#hdnFBPageURL").val(), success: function (result) {
...
<script type="text/javascript" src="https://www.tsmaapplication.com/Content/js/custom.js"></script>
<script src="https://www.tsmaapplication.com/Content/facebox/facebox.js" type="text/javascript"></script>
<script type="text/javascript">
...
//                            method: 'feed',
//                            name: 'ForRent.com',      
//                            link: 'http://www.training.tsmaapplication.com/',
//                            picture: 'http://www.training.tsmaapplication.com/Content/images/for_rent_logo.jpg',
//                            caption: 'ForRent.com',
//                            description: 'You can share your reviews on Facebook',
//                            message: ''
//                        });
...
<script type="text/javascript" src="https://www.tsmaapplication.com/content/js/ajax.js"></script>
</head>
<body>
<script>
    window.fbAsyncInit = function () {
        FB.init({
          ...
          //  appId: '265821080167427',  //for training.tsmaapplication.com
...
<form id="form1" runat="server" >
  <div id="divContent" style="width:520px;" runat="server"></div>
</form>
...
<input type="hidden" id="hdnFBPageURL" runat="server" name="hdnFBPageURL"  />
...
<script type="text/javascript" src="../Content/js/fancybox/fancybox/jquery.fancybox-1.3.4.pack.js"></script>
    ...
    <script type="text/javascript" src="../Content/js/fancybox/fancybox/videofb.js"></script>
<script type="text/javascript">
