<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="upload_photo.aspx.vb" Inherits="tsma.upload_photo" %>
            ...
            <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td align="left" valign="top" class="contentborder">
                    <div style="padding-bottom:20px"><h2>Upload Photo</h2></div>
                    ...
                    <tr>
                      ...
                      <td height="25" align="left">
                         <input  type="file" id="propicture" runat="server" /><br/><br/>
                         <input id="txtname" runat="server"  type="text" /><br/><br/>
                    ...
                    <tr>
                      ...
                      <td height="30" align="left">
                       <input type="submit" value="Upload" id="btnsubmit"/><br/>
