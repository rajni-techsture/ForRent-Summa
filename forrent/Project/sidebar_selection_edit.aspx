<%@ Page Language="vb" AutoEventWireup="false" Debug="true" validateRequest="false" CodeBehind="sidebar_selection_edit.aspx.vb" Inherits="tsma.sidebar_selection_edit" %>
...
<script type="text/javascript">
               ...
               function SaveAlert(mess)
				...
				function HideSidebarNameAlert() {
				    $("#DivSidebarName").hide("slow");
				    $('#spinner').fadeIn('slow');
...
<script type="text/javascript" src="Content/facebookalert/facebookalert_files/jquery_facebook.alert.js"></script>
	<script type="text/javascript">
	    function FacebookAlert() {
	        jConfirm('Warning: Reset will discard your changes.', 'Reset Sidebar',
				    function (r) {
				        if (r == true) {
				...
				function DownloadAlert() {
				    jPrompt('Sidebar will be downloaded to download folder on your computer', ' test ', 'Download Sidebar',
				    function (r) {
				        if (r == true) {
...
<script type="text/javascript">
   function chkTemplatePage3(mess) {
			...
			if (test == "1")
			{	
				window.parent.location.href= 'create-sidebar';
				return true;
			}
			else
			{
...
<!-- Content End  here -->
<!--new_html-->
<span id="spnSidebar" runat="server" style="display:"> </span>
...
<div class="content_div" style="padding-top:20px; padding-left:70px;">
 <div id="DivSaveSidebar" style="width:100%; height:100%; text-align:center; background-image:url(Content/facebookalert/images/popup_bg.png); position:absolute; z-index:999999999; text-align:center;  display:none;">
			  <div id="popup_container1" style="width:450px; height:80px;" >
			    <div id="popup_content" style="padding-top:10px; padding-left:20px; text-align:left">
                   ...
                   <input type="button" class="inputbutton" onclick="HideSaveAlert();" value="Close" style=" cursor:pointer" style="cursor:pointer" id="popup_close" />
				</div>
			 </div>
			 </div>
   <div id="DivSidebarName" style="width:100%; height:100%; text-align:center; background-image:url(Content/facebookalert/images/popup_bg.png); position:absolute; z-index:999999999; text-align:center;  display:none;">
			  <div id="popup_container1" style="width:450px; height:80px;" >
			    <div id="popup_content" style="padding-top:10px; padding-left:20px; text-align:left">
                  Sidebar Name:  <input type="text" runat="server" id="txtSidebarName" width="100" height="20" /><br/><br/>
                   <input type="button" class="inputbutton" onclick="HideSidebarNameAlert();" style="cursor:pointer" value="Save" id="popup_save" />
				</div>
			 </div>
			 </div>
  ...
  <asp:UpdatePanel ID="uptMain1" runat="server">
    <ContentTemplate>
      <div class="watch_video_tut_box2" style="width:150px;">
        <div class="side_bar_custom">
          <div style="height:25px; margin-left:0px; font-size:18px"><b> </b>
           ...
           <div style="font-family: Tahoma, Geneva, sans-serifthaoma; font-size: 14px; color: #181818; font-weight:bold; text-align:center; "><asp:Label ID="txtname" runat="server"></asp:Label></div> 
          <div style="width:180px;float:left;" id="presentation_html" align="left" >
            <style type="text/css">
        html,body{padding:0px;margin:0px;background-color: transparent;}.SafariBgFix{background-repeat:no-repeat;}
        </style>
            <br />
            <div id="divSidebarHtml" runat="server"></div><br />
            <font style=" font-size:14px; font-weight:bold"><span id="lnkFanPageName" runat="server"></span></font>
          </div>
        </div>
      </div>
    </ContentTemplate>
  </asp:UpdatePanel>
  <div class="watch_video_tut_box">
  
  
<table width="387" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="34" style="text-align:right; vertical-align:middle" ><img src="Content/images/quick_start_tutorial_left_arrow.png" width="34" height="100"></td>
    <td align="left" valign="top" style="padding:27px; padding-top:15PX; border-bottom:1px solid #dde2eb; border-right:1px solid #dde2eb; background-color:#EDEFF4"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td style="font-size:22px; color:#3b3b3b; text-align:left; vertical-align:middle">Design Your Sidebar</td>
          </tr>
        </table></td>
      </tr>
      ...
      <tr>
        <td style="border:1px solid #bdc7d8; background-color:#FFF; padding-left:20px; padding-right:20px;">                <div id="editor-nav">
                  <div class="editor-nav-panel rc-m">
                    <div class="editor-nav-panel-content">
                    <%--<a  href="#" class="nav-action-button rc-m rm-css-control-close" title="Watch Video Tutorial" onclick="$('#helptext12').fadeIn();" style="display:none"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Watch Video Tutorial</a> --%>
                    <div id="helptext1" style="background-image:url(http://mysocialmediaagency.com/mysocialmediaagency/images/facebook_frame_coaching2_video_bg.png); background-position:top; background-repeat:no-repeat; width:660px; height:474px; text-align:left;position:absolute;top:-200px;left:-360px;display:none;z-index:90000">
                      ...
                      <a id="rm-content-launch"  href="#launch-content" class="nav-action-button rc-m rm-css-control-close" title="Edit text content"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Edit Text</a> <a id="rm-css-launch" href="#launch-css" class="nav-action-button rc-m " title="Edit Appearance of the Presentation!"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Edit Color & Images</a> <a id="ch_temp"  href="javascript:;" target="_parent" class="nav-action-button rc-m " title="Change Template for this Page." onclick="chkTemplatePage3('Warning! Please Save your work befor leave this page othrewise your changes will be descarded');"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Change Template</a><a id="lnkResize"  href="javascript:;" target="_parent" class="nav-action-button rc-m " style="width:190px;" title="Crop Image" onclick="PopupCenter('crop2.aspx', 'Resize','800','700');"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Crop Image</a><a href="javascript:;" onclick="FacebookAlert();" class="nav-action-button rc-m " title="Reset selected template"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Reset</a><a href="#" id="lnkReset" runat="server" style="display:none" ></a>
                      <a href="#"  class="nav-action-button rc-m " title="Save Sidebar" id="lnkSaveName" runat="server" onclick="SaveSidebar();GetWidthHeight();" ><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Save</a><a href="#" id="lnkSave" runat="server" style="display:none"></a>
                      <a href="#"  class="nav-action-button rc-m " title="Publish Sidebar" id="lnkPublish" runat="server" onclick="PublishSidebar();GetWidthHeight();"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"/>Publish Sidebar</a>
                      <a href="#"  class="nav-action-button rc-m " title="Download" onclick="DownloadAlert();DownloadSidebar();GetWidthHeight();" style="display:none"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Download</a>
...
<div style="display:none; opacity: 1; left: 758px; top: 244px; height: 258px; width:420px; clear:both; padding-left:30px;" id="rm-appearance-panel" class="">
<div style="background-image:url(content/sidebar-images/widget_box_bg.png); width:392px;height:187px;  padding:0px; padding-top:9px;display:a"  id="rm-appearance-type" class="rm-css-subpanel" >
...
div.selector {
    ...
    <div style="float:right; margin-top:7px;"><a href="#"   title="Close Visual Editor">
...
<div id="hide"></div>
<form method="post" action="" id="SidebarDownloadCodeForm" target="downloadiframe" >
