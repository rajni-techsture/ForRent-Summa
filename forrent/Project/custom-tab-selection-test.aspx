            ...
            <script type="text/javascript">
                ...
                */
                ...
                function ValidateSaveName() {
                    /*var t124 = <%=strFBUserId%> + "-tabs";
                    alert("test" + t124);*/
                    var Title = "Please Fill in Following Information\n";
                    var fields = "";
                    if ($.trim($('#txtCustomTabName').val()) == '') {
                        fields = fields + "\n-- Custom Tab Name --";
                    }
                    if (fields.length > 0) {
                        alert(Title + fields);
                ...
                function showSharePages() {
                    var pos;
                    pos = findPos(document.getElementById('imgShare'));
                    var lft = pos[0] - 540;
                    document.getElementById('divSharePages').style.left = lft + 'px';
                    lft = pos[1] + 10;
                    document.getElementById('divSharePages').style.top = lft + 'px';
                    $('#divSharePages').slideDown('slow');
                }
                function CloseSharePages() {
                    $('#divSharePages').slideUp('slow');
                }
                function ValidateShareName() {
                    var Title = "Please Fill in Following Information\n";
                    var fields = "";
                    if ($.trim($('#txtShareTabName').val()) == '') {
                        fields = fields + "\n-- Custom Tab Name --";
                    }
                    if (fields.length > 0) {
                        alert(Title + fields);
                ...
                function ShareAlert() {
                    var maskHeight = $(document).height();
                    var maskWidth = $(window).width();
                    $('#DivShareCustomTab').css({ 'width': maskWidth, 'height': maskHeight });
                    $("#DivShareCustomTab").show("slow");
                }
                function HideShareAlert() {
                    $("#DivShareCustomTab").hide("slow");
                }
...
<script type="text/javascript" src="Content/js/custom-new-test.js"></script>
...
<script type="text/javascript">
    ...
    function OpenShareTabName() {
        $("#DivShareTabName").show("slow");
    }
...
<input type="hidden" id="hdnSidebarContent" runat="server" />
  <input type="hidden" id="hdnWidth" runat="server"/>
    ...
    <div id="DivShareCustomTab" style="width:100%; height:100%; text-align:center; background-image:url(Content/facebookalert/images/popup_bg.png); position:absolute; z-index:999999999; text-align:center;  display:none;">
			  <div id="popup_container1" style="width:450px; height:80px;"  >
			    <div id="popup_content" style="padding-top:10px; padding-left:20px; text-align:left">
                  Custom Tab Shared Successfully<br/><br/>
                   <input type="button" class="inputbutton" style="cursor:pointer" onclick="HideShareAlert();" value="Close" id="lnkRedirectShare" runat="server"/>
				</div>
			 </div>
	</div>
      <div id="DivPublishSaveCustomTab" style="width:100%; height:100%; text-align:center; background-image:url(Content/facebookalert/images/popup_bg.png); position:absolute; z-index:999999999; text-align:center;  display:none;">
			  <div id="popup_container1" style="width:450px; height:80px;"  >
			    <div id="popup_content" style="padding-top:10px; padding-left:20px; text-align:left">
                  Custom Tab published to your Page successfully<br/><br/>
    ...
    <div id="DivCustomTabName" style="width:100%; height:100%; text-align:center; background-image:url(Content/facebookalert/images/popup_bg.png); position:absolute; z-index:999999999; text-align:center;  display:none;">
			  <div id="popup_container1" style="width:450px; height:80px;" >
			    <div id="popup_content" style="padding-top:10px; padding-left:20px; text-align:left">
                  Custom Tab Name:  <input type="text" runat="server" id="txtCustomTabName" width="100" height="20" /><br/><br/>
                   <a href="javascript:;" id="lnkSave" runat="server" style="display:" class="bluetablink" onclick="return ValidateSaveName();">Save</a>&nbsp;&nbsp;<a href="javascript:;" class="bluetablink" onclick='$("#DivCustomTabName").hide("slow");'>Cancel</a>
				</div>
			 </div>
	</div>
    
    <div id="DivShareTabName" style="width:100%; height:100%; text-align:center; background-image:url(Content/facebookalert/images/popup_bg.png); position:absolute; z-index:999999999; text-align:center;  display:none;">
			  <div id="popup_container1" style="width:450px; height:80px;" >
			    <div id="popup_content" style="padding-top:10px; padding-left:20px; text-align:left">
                  Custom Tab Name:  <input type="text" runat="server" id="txtShareTabName" width="100" height="20" /><br/><br/>
                   <a href="javascript:;" id="lnkShareName" runat="server" style="display:" class="bluetablink" onclick="return ValidateShareName();">Save</a>&nbsp;&nbsp;<a href="javascript:;" style="display:" class="bluetablink" onclick='$("#DivShareTabName").hide("slow");'>Cancel</a>
				</div>
			 </div>
	</div>
    ...
    <div id="DivPublishCustomTab" style="width:100%; height:100%; text-align:center; background-image:url(Content/facebookalert/images/popup_bg.png); position:absolute; z-index:999999999; text-align:center;  display:none;">
			  <div id="popup_container1" style="width:450px; height:80px;"  >
			    <div id="popup_content" style="padding-top:10px; padding-left:20px; text-align:left">
                  Custom Tab will be created on your selected business page(s)!<br/><br/>
	...
	line-height:18px; text-align:center"><asp:Label ID="lblMessage" runat="server" ForeColor="Red" Font-Bold="true" Font-Size="Larger"></asp:Label>
    </div>
...
<ContentTemplate>
  <div  style="float:center; font-family: Tahoma, Geneva, sans-serifthaoma; font-size: 14px; color: #181818; font-weight:bold; text-align:center; "><asp:Label ID="txtname" runat="server"></asp:Label></div> 
  <div align="left" style="width:500px; padding-left:10px;">
    <div class="side_bar_custom" style="padding:0px;">
      <div style="height:5px; margin-left:0px; font-size:18px"><b>
        </b>
...
<table align="right" width="270" border="1" cellspacing="0" cellpadding="0">
   ...
   <td align="left" valign="top" style="padding:15px; padding-top:15PX; border-bottom:1px solid #dde2eb; border-right:1px solid #dde2eb; background-color:#EDEFF4"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td style="border:1px solid #bdc7d8; background-color:#FFF; padding-left:20px; padding-right:20px;">  
         <div id="helptext1" style="background-image:url(content/images/facebook_frame_coaching2_video_bg.png); background-position:top; background-repeat:no-repeat; width:660px; height:474px; text-align:left;position:absolute;top:265px;left:170px;display:none;z-index:90000">
               ...
               <div id="editor-nav">
                  <div class="editor-nav-panel rc-m">
                    <div class="editor-nav-panel-content"> 
                     <a href="#" class="nav-action-button rc-m rm-css-control-close" style="width:190px;" title="Watch Video Tutorial" onclick="$('#helptext1').fadeIn();"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Watch Video Tutorial</a>
                      ...
                      <a id="rm-content-launch"  href="#launch-content" style="width:190px;" class="rm-css-control-close nav-action-button rc-m " title="Edit text content"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Edit Text / Upload Video</a> 
                      
                      <a id="rm-css-launch" href="#launch-css" class="nav-action-button rc-m " style="width:190px;" title="Edit Appearance of the Presentation!"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Edit Color & Images</a> 
                      ...
                      <a id="ch_temp"  href="create-custom-tab" target="_parent" class="nav-action-button rc-m " style="width:190px;" title="Change Template for this Page." onclick="return SubMenu(this);"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Change Template</a>
                      <a id="lnkResize"  href="javascript:;" target="_parent" class="nav-action-button rc-m " style="width:190px;" title="Crop Image" onclick="PopupCenter('crop2.aspx', 'Resize','900','800');"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Crop Image</a>
                      <a  href="#launch-css" class="nav-action-button rc-m " style="width:190px;" title="Unhide Hidden Icons" onclick="$('.url').css('display','');"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Unhide Icons</a>
                      <a href="javascript:;" onclick="FacebookAlert();" style="width:190px;" class="nav-action-button rc-m " title="Reset selected template"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Reset</a><a href="#" id="lnkReset" runat="server" style="display:none" ></a>
                      <a href="javascript:;" class="nav-action-button rc-m " style="width:190px; display:;" title="Share With Business Page Admins" id="lnkPublish"  onclick="showSharePages();"><img id="imgShare" src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px; line-height:20px;"  />Share With Business &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Page Admins</a>
                      <a href="#"  class="nav-action-button rc-m " style="width:190px;" title="Save CustomTab" id="lnkSaveName" runat="server" onclick="OpenDivCustomTabName();" ><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Save</a>
                      <a href="javascript:;" class="nav-action-button rc-m " style="width:190px;" title="Publish CustomTab" id="lnkPublish"  onclick="showPages();"><img id="img1" src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Publish Custom Tab</a>
                      <div style="padding-left:10px;">  <img id="imgLoading" src="Content/images/bigspinner.gif" style="display:none" /> </div>
                      <!-- <a href="http://www.picnik.com/app" target="_blank" class="nav-action-button rc-m " title="Resize Image" >Resize Image</a> 
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
				  ...
				  <td valign="middle">
				  <b>To add a Custom tab, select a Business Page(s)</b>
				  </td>
   			 ...
   			 <div style="width:650px; height:450px; overflow:auto; background-color:#ffffff;padding:0px; padding-top:0px; border:1px solid #cccccc;">
  ...
  <tr>
    ...
    <a id="btnSave" class="bluetablink" runat="server" onclick="return ValidatePublish();" title="Publish Custom Tab">Publish Custom Tab</a>&nbsp;<a id="lnkDownload" class="bluetablink" runat="server" title="Download Sidebar" style="display:none;">Download Sidebar</a>
    <a id="btnUpload" runat="server" style="display:none">Publish Custom Tab</a>
    </td>
  </tr>
  </table>
  </td>
    ...
    <div id="divSharePages" class="divSharePages" style="display:none; width:670px; height:450px; border:0px solid #ff0000; position:absolute; z-index: 1000;">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
    	 	<tr>
                  <td align="right" valign="top" class="greypopupbordertop" style="padding-right:30px;">
				  <img src="../Content/images/grey_popup_top.gif" width="31" height="11" />
          ...
          <tr>
				  ...
				  <td align="right" valign="middle">
					 <a href="javascript:;" onclick="CloseSharePages();">[Close]</a>&nbsp;&nbsp;&nbsp;
				  </td>
				  </tr>
 				<tr>
				  <td colspan="2" valign="top">
   			 <div style="width:650px; height:450px; overflow:auto; background-color:#ffffff;padding:0px; padding-top:0px; border:1px solid #cccccc;">
       <asp:PlaceHolder ID="plcShareData" runat="server">
					<asp:DataList ID="dstShareFanPages" runat="server" RepeatColumns="3" RepeatDirection="Horizontal">
                      <ItemTemplate>
                      <table id="NonFanPage" runat="server" width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
							<td colspan="2" style="border-top:0px solid #cccccc;height:20px;">
           ...
           <asp:PlaceHolder ID="plcShareNoData" runat="server" Visible="false">
				   <strong style="color:#990066">  You have no business pages.</strong><br /><br /> <a href="javascript:CreatePage();">Click here</a> to create business page. 
		   </asp:PlaceHolder> 
           <asp:PlaceHolder ID="plcShareError" runat="server" Visible="false">
                                           <strong style="color:#990066">Facebook is experiencing problems. Please try again later</strong><br /><br />
           </asp:PlaceHolder>
     </div>
  ...
  <tr>
    <td height="20" align="left" valign="middle" style="padding-top:10px;">
    <a id="btnShareSave" href="javascript:;" class="bluetablink" onclick="return ValidateShare();" title="Save And Assign to a page">Share With Business Page Admins</a>&nbsp;
    </td>
  </tr>
  </table>
  </td>
			...
			<img src="content/images/demo_wait.gif" align="absmiddle"  />&nbsp;Adding Custom Tab to your page...
			</td>
			</tr>
			</table>
			</div>
            ...
            <div style="display:none;  padding:15px; padding-top:1100px;  position:absolute; z-index:10000;" id="dvMessage" >
	       	<div style="border:2px solid #000000; width:350px; height:80px; background-color:#FFFFFF;" >
				<table cellpadding="0" cellspacing="0" border="0" width="100%">
				  ...
				  Custom Tab has been successfully added to your business page.<br />
				  </span>
				  </td>
				  </tr>
				  </table>                     
...
<div style="display:none; opacity: 1; left: 600px; width:420px; top: 244px; height: 258px;clear:both;" id="rm-appearance-panel">
...
div.selector {
    ...
    position: relative;
      ...
      <div style="float:right; width:66px; margin-top:7px;"><a href="#"   title="Close Visual Editor"> 
        <!--<img src="content/sidebar-images/widget_icon_close.png" width="66" height="17" border="0" />--></a></div>
    </div>
  </div>
...
<input type="hidden" id="hdnResizeCheck" value="1" />
        ...
        <img src="content/images/c.png" style="cursor:pointer;" id="imgResizeCb" onclick="CheckThis(this);" />
 </div>
         </div>
      ...
      <div style="height:32px;">
        ...
        <div style="float:left; padding-top:5px;"><a href="#" id="rm-css-bgrepeat-x"><img src="content/sidebar-images/widget_repeat_x.png" width="30" height="26" /></a>&nbsp;<a href="#" id="rm-css-bgrepeat-y" ><img src="content/sidebar-images/widget_repeat_y.png" width="30" height="26" hspace="4" /></a>&nbsp;<a href="#" id="rm-css-bg-transparent" style="display:none"><img src="content/sidebar-images/widget_repeat_no.png" width="30" height="26" /></a>
      </div>
      </div>
      <div style="border-bottom:1px solid #dddddd; height:7px;"></div>
    </div>
...
<script type="text/javascript">
    ...
    */
    ...
    $(".url").click(function (e) {
        ...
        /*form='<div style="font-size:16px"><b>Enter Website URL : </b><br><br><input type="text" id="url" value="' + url + '"  size="38" style="font-size:16px"/><br><br> Hide: <input type="checkbox" onclick="seturlimagehide(\'' + $(".url").index(this) + '\',this.checked);" />
        <div style=" border-top: 1px solid #DDDDDD; padding-top: 5px; margin-top: 10px; text-align: right; padding-bottom:5px;">
        <div style="padding-top:5px;"><a href="javascript:;" class="bluetablink" onClick="' + func + '(document.getElementById(\'url\').value,\'' + $(".url").index(this) + '\');fboxhide();">Save and Close</a></div>
        </div>
        </div>';*/
    ...
    /* this is test for auto resize
	
    $(".url12").click(function (e) {
    if($('#chkResize').attr('checked') == true)
    {
    alert('false check');
    $('#chkResize').attr('checked',false);
    return false;
    }
    else
    {
    alert('true check');
    $('#chkResize').attr('checked',true);			
    return false;			
    }
    //alert('test' + $('#chkResize').attr('checked'));
    });*/
    ...
    function videobig(url, id) {
        ...
        $('#' + id).html('<a href="javascript:;" rel="' + urlnew + '&fs=1&rel=0&enablejsapi=1&playerapiid=ytplayer;" class="video"><img src="' + photo + '" height="' + height + '" width="' + width + '" style="z-index=-100;"><div style="z-index: 10; left: ' + widthhalf + 'px; position: absolute; top: ' + heighthalf + 'px"><img src="../content/images/play_icon.png" style="z-index:10; "></div> </a>');
        // $.ajax({
        //            url: 'ajax.php',
