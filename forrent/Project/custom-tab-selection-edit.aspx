<%@ Page Language="vb" AutoEventWireup="false" Debug="true" validateRequest="false" CodeBehind="custom-tab-selection-edit.aspx.vb" Inherits="tsma.custom_tab_selection_edit" %>
...
<input type="hidden" id="hdnSidebarContent" runat="server" />
  <input type="hidden" id="hdnWidth" runat="server"/>
	...
	line-height:18px; text-align:center">&nbsp;<br /><asp:Label ID="lblMessage" runat="server" ForeColor="Red" Font-Bold="true" Font-Size="Larger"></asp:Label></div><br />
                  ...
                  <div class="editor-nav-panel rc-m">
                    <div class="editor-nav-panel-content"> 
                     <a href="#" class="nav-action-button rc-m rm-css-control-close" style="width:190px;" title="Watch Video Tutorial" onclick="$('#helptext1').fadeIn();" ><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Watch Video Tutorial</a> 
                      ...
                      <a href="javascript:;" class="nav-action-button rc-m " style="width:190px; display:;" title="Share CustomTab with page admins" onclick="showSharePages();"><img id="imgShare" src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px; line-height:20px;"  />Share With Business &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Page Admins</a>
                      ...
                      <div style="padding-left:10px;"> <img id="imgLoading" src="<%=ResolveUrl("~/Content/images/uploading.gif")%>" style="display:none;" /> </div>
...
<table align="right" width="270" border="1" cellspacing="0" cellpadding="0">
  ...
  <td width="20" style="text-align:right; vertical-align:middle" ><img src="Content/images/quick_start_tutorial_left_arrow.png" width="20" height="100"></td>
   <td align="left" valign="top" style="padding:15px; padding-top:15PX; border-bottom:1px solid #dde2eb; border-right:1px solid #dde2eb; background-color:#EDEFF4"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="center" style="vertical-align:middle; line-height:18px; padding-top:10px; padding-bottom:15px;">
       <span id="spnAssigned" runat="server"></span></td>
      </tr>
    </table></td>
  </tr>
</table>
...
<div id="divSharePages" class="divSharePages" style="display:none; width:670px; height:450px; border:0px solid #ff0000; position:absolute; z-index: 1000;">
  ...
  <tr>
    <td height="20" align="left" valign="middle" style="padding-top:10px;">
    <a id="btnShareSave" href="javascript:;" class="bluetablink" runat="server" onclick="ValidateShare();" title="Save And Assign to a page">Share With Business Page Admins</a>&nbsp;
    </td>
  </tr>
  </table>
  </td>
