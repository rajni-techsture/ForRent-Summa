<%@ Page Language="vb" ValidateRequest="false" AutoEventWireup="false" CodeBehind="selection.aspx.vb" Inherits="tsma.selection_test" %>
                        ...
                        <div id="helptext1" style="background-image:url(content/images/facebook_frame_coaching2_video_bg.png); background-position:top; background-repeat:no-repeat; width:660px; height:474px; text-align:left;position:absolute;top:265px; left:270px; display:none;z-index:90000">
                          ...
                          <div id="editor-nav">
                            <div class="editor-nav-panel rc-m">
                              ...
                              <a id="rm-css-launch" href="javascript;" class="nav-action-button rc-m " style="width:180px;" title="Edit Appearance of the Presentation!"><img src="Content/images/edit_color_icon.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Edit Color & Images</a> <a id="ch_temp"  href="javascript:;" target="_parent" class="nav-action-button rc-m " style="width:180px;" title="Change Template for this Page." onclick="chkTemplatePage3('Warning! Please Save your work before leaving this page othrewise your changes will be discarded');"><img src="Content/images/change_template_icon.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Change Template</a><a id="lnkResize"  href="javascript:;" target="_parent" class="nav-action-button rc-m " style="width:180px;" title="Crop Image" onclick="PopupCenter('crop2.aspx', 'Resize','800','700');"><img src="Content/images/crop_img_icon.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Crop Image</a><a id="A1"  href="javascript:;" target="_parent" class="nav-action-button rc-m " style="width:180px;" title="Rotate Image" onclick="PopupCenter('rotate-image.aspx', 'Resize','800','700');"><img src="Content/images/crop_img_icon.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Rotate Image</a> <a  href="#launch-css" class="nav-action-button rc-m " style="width:180px;" title="Unhide Hidden Icons" onclick="$('.url').css('display','');"><img src="Content/images/unhide_icons.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Unhide Icons</a> <a href="javascript:;" onclick="FacebookAlert();" style="width:180px;" class="nav-action-button rc-m " title="Reset selected template"><img src="Content/images/reset_icon.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Reset</a><a href="#" id="lnkReset" runat="server" style="display:none" ></a> 
                              <a href="javascript:;"  class="nav-action-button rc-m " style="width:180px;" title="Save CustomTab" id="lnkSaveName" onclick="return OpenDivCustomTabName();" ><img src="Content/images/save_icon_sidebar.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Save</a> <a href="javascript:;"  class="nav-action-button rc-m " style="width:180px;" title="Share Custom Tab" id="lnkShare" onclick="return OpenDivShareCustomTabName();" ><img src="Content/images/share_icon.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Share</a> <a href="javascript:;" class="nav-action-button rc-m " style="width:180px;" title="Publish CustomTab" id="lnkPublish"  onclick="showPages();"><img id="img1" src="Content/images/publish_custom_tab_icon.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Publish Custom Tab</a>
