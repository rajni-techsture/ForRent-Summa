<%@ Page Language="vb" AutoEventWireup="false" Debug="true" EnableEventValidation="false" ValidateRequest="false" CodeBehind="scheduler-new.aspx.vb" Inherits="tsma.scheduler_new" %>
...
<script type="text/javascript" language="javascript">
    ...
    function ErrorAlert(mess) {
        var maskHeight1 = $(document).height();
        var maskWidth1 = $(window).width();
        $('#DivError').css({ 'width': maskWidth1, 'height': maskHeight1 });
        $("#spnErrorMessage").html(mess);
        $("#DivError").show("slow");
    }
    ...
    function EditLib(Id) {
		...
		var regex = /<br\s*[\/]?>/gi;
        $('#txtMessage').val($.trim($('#spnlib' + Id).html()).replace(regex,""));
        $('#txtVideoMessage').val($.trim($('#spnlib' + Id).html()).replace(regex,""));
        $('#txtLinkMessage').val($.trim($('#spnlib' + Id).html()).replace(regex,""));
    }
    function EditAutoPost(Id) {
		...
		var regex = /<br\s*[\/]?>/gi;
        $('#txtMessage').val($.trim($('#spnAutoPost' + Id).html()).replace(regex,""));
        $('#txtVideoMessage').val($.trim($('#spnAutoPost' + Id).html()).replace(regex,""));
        $('#txtLinkMessage').val($.trim($('#spnAutoPost' + Id).html()).replace(regex,""));
    }
    ...
    function CheckVideo() {
        ...
        if (obj.value != '') {
            ...
            if (vid != '') {
                ...
                document.getElementById('imgThumbnail').src = "https://img.youtube.com/vi/" + vid + "/2.jpg";
                document.getElementById('hdnVideoId').value = vid;
                document.getElementById('hdnUrl').value = "https://img.youtube.com/vi/" + vid + "/2.jpg";
                return true;
            }
            /*else {
...
<body onload="CheckMessage();showFangPageDiv();">
...
<div id="DivError" style="width:100%; height:1450px; text-align:center; background-image:url(../Content/facebookalert/images/popup_bg.png); position:absolute; z-index:999999999; text-align:center; padding-left:150px;  display:none;">
			  <div id="popup_container1" style="width:450px;">
			    <div id="popup_content" style="padding-top:10px; padding-left:20px; text-align:left">
                   <span id="spnErrorMessage"></span><br/><br/>
                   <a href="javascript:;" id="A1" onclick="$('#DivError').hide('slow');" class="bluetablink">Close</a>
				</div>
			 </div>
	</div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td align="left" valign="top" class="contentbody" style="padding-left:10px; padding-right:10px;"><div style="padding-bottom:10px;">
              <center>
                <asp:Label ID="lblMessage" ForeColor="#FF0000" Font-Bold="false" Font-Size="12" runat="server">1212</asp:Label>
              </center>
              <h6>Quick Post and Scheduler</h6>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                              ...
                              <td align="left" valign="top" style="padding:7px; font-family:arial;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td align="left" colspan="2" height="50" style="border:1px solid #999999"><textarea style="width: 785px; border:0px" id="txtVideoMessage" runat="server" cols="80" rows="5"
                                                                    name="txtVideoMessage" class="menu_showhide12"></textarea>                                    </td>
                                  </tr>
                                  <tr>
                                    <td align="left" style="padding-top:10px;"><strong>Select an image file on your computer.</strong><br />
                                      ...
                                      <input type="hidden" id="hdnImageChange" runat="server" />                                    </td>
                                  </tr>
                                </table></td>
                            </tr>
                          </table></td>
                              ...
                              <td align="left" valign="top" style="padding:7px; font-family:arial;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td align="left" colspan="2" height="50" style="border:1px solid #999999"><textarea style="width: 785px; border:0px" id="txtPhotoMessage" runat="server" cols="80" rows="5"
                                                                    name="txtPhotoMessage" class="menu_showhide12"></textarea>                                    </td>
                                  </tr>
                                  <tr>
                                    <td align="left" style="padding-top:10px;"><strong>Add a youtube video url.</strong><br />
                                      <input type="text" id="txtVideoLink" name="txtVideoLink" runat="server" style="width:490px;" onchange="validateURL();" />                                    </td>
                              ...
                              <td align="left" valign="top" style="padding:7px; font-family:arial;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td align="left" colspan="2" height="50" style="border:1px solid #999999"><textarea style="width: 785px; border:0px" id="txtLinkMessage" runat="server" cols="80" rows="5"
                                                                    name="txtLinkMessage" class="menu_showhide12"></textarea>                                    </td>
                                  </tr>
                                  <tr>
                                    <td align="left" style="padding-top:10px;"><input type="text" id="txtvideo" runat="server" width="720" style="width:720px; " onchange="CheckVideo();" onkeydown="return FocusOnEnter(event)" />
                                      ...
                                      <input type="hidden" id="hdnVideoId" runat="server" value="" />                                    </td>
                                                ...
                                                <td align="center" valign="middle"><table border="0" width="170" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                      ...
                                                      <td align="left" width="150" valign="middle"><%#Eval("name")%>
                                                        ...
                                                        <input type="hidden" id="hdnImage" runat="server" value='<%#Eval("picture")%>' />                                                      </td>
                                                    </tr>
                                                  </table></td>
                                              </tr>
                                            </table></td>
                                  ...
                                  <tbody>
                                    ...
                                    <tr id="trCreateNew" style="display:none">
                                      <td align="left"><input type="text" id="txtNewLibCat" runat="server" width="150" style="width:130px;" />
                                        &nbsp;
                                        <asp:LinkButton onclientclick = "return ValidateNewLibCat()" id="lnkCreateNewCat" runat="server" OnCommand="SaveToMyLibrary" CommandArgument="-1" >Create</asp:LinkButton>                                      </td>
                                    </tr>
                                  </tbody>
                                </table></td>
                            </tr>
              ...
              <tr>
                ...
                <td height="30" align="left" valign="middle" style="padding-top:10px; padding-bottom:10px; ">
                <div id="divHtml" style="width:300px; display:none; height:auto; border:1px solid #eaeaea; background-color:#f6f6f6; padding:15px; line-height:22px;"> </div>
                <input type="hidden" id="hdnPageSelected" value="" runat="server" />
                <input type="hidden" id="hdnPostType" value="" runat="server" />
                </td>
              </tr>
              <tr>
              <td height="25" align="right"></td>
              ...
              <tr>
                ...
                <td height="32" align="left" valign="bottom" >
                	<!--<asp:UpdatePanel id="pnlMainOutSide" runat="server">
            <ContentTemplate> -->
...
<li>
  <div id="divFanPageDrp" style="display:none" >
                        <asp:DropDownList ID="drpFanPages" runat="server" AutoPostBack="true" CssClass="inputdropdown">
                         </asp:DropDownList>
                         </div>
</li>
                                                          ...
                                                          <tr>
                                                            ...
                                                            <tr>
                                                              ...
                                                              <div id="divAdminLibVideo" visible='<%#DataBinder.Eval(Container.DataItem, "lib_VideoId")<>""%>' runat="server" style="padding-bottom:10px; padding-right:15px;">
                                                                <script type="text/javascript">
AC_AX_RunContent( 'style','height: 100px; width: 100px','src','<%#DataBinder.Eval(Container.DataItem, "VideoUrl")%>','type','application/x-shockwave-flash','allowfullscreen','true','allowscriptaccess','always','width','100','height','100','movie','<%#DataBinder.Eval(Container.DataItem, "VideoUrl")%>','wmode','transparent' ); //end AC code
</script><noscript><object style="height: 100px; width: 100px">
                                ...
                                <td align="left" valign="top"><asp:Literal id="ltrScheduledPosts" runat="server"></asp:Literal>
                                  <asp:DataList ID="dtlScheduledPosts" runat="server" Width="100%"  >
                                    <ItemTemplate>
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                          <td height="40" align="left" valign="top" style="background-color:#fafafa; padding:8px; border:1px  solid #ecebeb; line-height:30px; padding-left:15px;">
                                         
                                          <strong>Updated By: </strong><%# DataBinder.Eval(Container.DataItem, "FBUserName")%>&nbsp;&nbsp;&nbsp;<font color="#828282">|</font>&nbsp;&nbsp;&nbsp;
                                          <strong>Last Updated On: </strong><%# DataBinder.Eval(Container.DataItem, "sm_UpdatedDate")%>&nbsp;&nbsp;&nbsp;<font color="#828282">|</font>&nbsp;&nbsp;&nbsp;
                                          <strong>Scheduled for </strong><label id="lblScheduleDate" runat="server"></label>
                                          <br />
                                            <asp:Repeater ID="rptScheduledPostsfanpages" runat="server" DataSource='<%# BindScheduledPostsFanPages(DataBinder.Eval(Container.DataItem, "sm_id")) %>' Visible="false">
                                              <ItemTemplate>
                                                    ...
                                                    <tr>
                                                      <td align="left" valign="top" style="line-height:18px;" >
                                                        <div style="display:none"><br />
                                                          <%#DataBinder.Eval(Container.DataItem, "sm_ScheduleDate")%> , <%#DataBinder.Eval(Container.DataItem, "sm_ScheduleHour")%>:<%#DataBinder.Eval(Container.DataItem, "sm_ScheduleMinute")%>&nbsp;<%#DataBinder.Eval(Container.DataItem, "sm_ScheduleAMPM")%></div>                                                        </td>
                                                      <td align="right" valign="top">
                                                      <a href='../scheduler-main/<%# Container.DataItem("sm_Id")%>' style="text-decoration:none;" title="Edit"><img src="../Content/images/icon_edit.gif" hspace="7" border="0" /></a>
                                                        <asp:ImageButton ImageUrl="Content/images/icon_delet.gif" OnClick="DeleteByID" CommandName='<%#DataBinder.Eval(Container.DataItem, "sm_Id")%>' OnClientClick="return confirm('Are you sure want to delete this Scheduled Post?');"  ID="btndelete" runat="server" ToolTip="Delete" />                                                      </td>
                                                    </tr>
                                                  </table></td>
                                              </tr>
                                            </table></td>
                                        ...
                                        <tr>
                                          <td height="40" align="left" valign="top" style="background-color:#fafafa; padding:8px; border:1px  solid #ecebeb; line-height:30px;"><font color="#0066CC"><strong>Business Page Selected: </strong></font><br />
                                           <asp:Repeater ID="rptSentItemsfanpages" runat="server"  DataSource='<%# BindSentItemsFanPages(DataBinder.Eval(Container.DataItem, "sm_id")) %>'>
                                              <ItemTemplate> 
                                              <img src='<%# DataBinder.Eval(Container.DataItem, "sp_FBPageImage")%>' width="20" height="20" align="absmiddle" border="0" style="border:1px solid #CCC; padding:1px;" />&nbsp;<font style="font-size:12px; font-family:Arial, Helvetica, sans-serif; line-height:20px;; vertical-align:middle"><%# DataBinder.Eval(Container.DataItem, "sp_FBPageName")%>&nbsp;&nbsp;&nbsp;</font>                                            </ItemTemplate>
                                            </asp:Repeater>                                            </td>
                                        </tr>
                                        <tr>
                                          <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
...
AC_AX_RunContent( 'style','height:100px; width: 100px','src','<%#DataBinder.Eval(Container.DataItem, "VideoUrl")%>','type','application/x-shockwave-flash','allowfullscreen','true','allowscriptaccess','always','width','100','height','100','movie','<%#DataBinder.Eval(Container.DataItem, "VideoUrl")%>','wmode','transparent' ); //end AC code
                                              ...
                                              <tr>
                                                <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                      <td align="left" valign="top" style="line-height:18px; display:"><strong>Post Submitted on</strong><br/>
...
AC_AX_RunContent( 'style','height: 100px; width: 100px','src','<%#DataBinder.Eval(Container.DataItem, "VideoUrl")%>','type','application/x-shockwave-flash','allowfullscreen','true','allowscriptaccess','always','width','100','height','100','movie','<%#DataBinder.Eval(Container.DataItem, "VideoUrl")%>','wmode','transparent' ); //end AC code
                                            ...
                                            <%--<%#DataBinder.Eval(Container.DataItem, "sm_ScheduleDate")%> , <%#DataBinder.Eval(Container.DataItem, "sm_ScheduleHour")%>:<%#DataBinder.Eval(Container.DataItem, "sm_ScheduleMinute")%>&nbsp;<%#DataBinder.Eval(Container.DataItem, "sm_ScheduleAMPM")%>--%>                                                        </td>
                                                      <td align="right" valign="top"><a href='../scheduler-main/<%# Container.DataItem("sm_Id")%>' style="text-decoration:none" title="Edit"><img src="../Content/images/icon_edit.gif"  hspace="7" border="0" /></a><asp:ImageButton ImageUrl="Content/images/icon_delet.gif" OnClick="DeleteByID" CommandName='<%#DataBinder.Eval(Container.DataItem, "sm_Id")%>' OnClientClick="return confirm('Are you sure want to delete this Draft?');"  ID="btndelete" runat="server" ToolTip="Delete" TabIndex="1000" />
                                              </asp:ImageButton>                                                      </td>
                                                    </tr>
                                                  </table></td>
                                              </tr>
