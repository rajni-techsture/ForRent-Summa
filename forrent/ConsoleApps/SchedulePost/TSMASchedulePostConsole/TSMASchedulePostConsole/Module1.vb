                        ...
                        For j As Integer = 0 To dsFanPages.Tables(0).Rows.Count - 1
                            If dsFanPages.Tables(0).Rows(j).Item("sp_FBPageAccessToken").ToString <> "" Then
                                ...
                                Catch ex As Exception
                                    InsertErrorLog(CInt(strid), CInt(strTsmaUserId), dsFanPages.Tables(0).Rows(j).Item("sp_FBUserId").ToString, dsFanPages.Tables(0).Rows(j).Item("sp_FBPageId").ToString, dsFanPages.Tables(0).Rows(j).Item("sp_FBPageAccessToken").ToString, ex.Message.ToString())
                                ...
                                End Try
                            Else
                                InsertErrorLog(CInt(strid), CInt(strTsmaUserId), dsFanPages.Tables(0).Rows(j).Item("sp_FBUserId").ToString, dsFanPages.Tables(0).Rows(j).Item("sp_FBPageId").ToString, dsFanPages.Tables(0).Rows(j).Item("sp_FBPageAccessToken").ToString, "Access token does not exists!")
                                intFailed = intFailed + 1
                                strFailedFanPageId = strFailedFanPageId & dsFanPages.Tables(0).Rows(j).Item("sp_FBPageId").ToString & ","
                                'strFailedFanPageId = dsFanPages.Tables(0).Rows(j).Item("sp_FBPageId").ToString
                                'strFailedFanPageId = "," & strFailedFanPageId
