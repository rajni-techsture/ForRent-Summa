        ...
        For Each dtRow As DataRow In ds.Tables(0).Rows
            If dtRow("AccessToken") <> "" Then
                Try
                    ...
                    If dtRow("Image") <> "" Then
                        Try
                            'Dim imagePath As String = "https://www.tsmaapplication.com/content/uploads/images/" & dtRow("Image").ToString
                            'Dim imagePath As String = "https://www.summasocialapp.com/content/uploads/images/" & dtRow("Image").ToString 'Convert.ToString(My.Application.Info.DirectoryPath & "\images\" & dtRow("Image").ToString).Replace("\bin\Debug", "")
                            'Dim imagePath As String = "http://so2.techsturedevelopment.com/content/uploads/images/" & dtRow("Image").ToString 'Convert.ToString(My.Application.Info.DirectoryPath & "\images\" & dtRow("Image").ToString).Replace("\bin\Debug", "")
                            Dim imagePath As String = "http://tsma2.techsturedevelopment.com/content/uploads/images/" & dtRow("Image").ToString 'Convert.ToString(My.Application.Info.DirectoryPath & "\images\" & dtRow("Image").ToString).Replace("\bin\Debug", "")
